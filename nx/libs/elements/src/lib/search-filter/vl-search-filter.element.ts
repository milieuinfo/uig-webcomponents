 ...
 */
export class VlSearchFilterElement extends vlElement(HTMLDivElement) {
  ...
  __processClasses() {
    this.querySelectorAll("form").forEach((form: Element) =>
    ...
    this.querySelectorAll("form > div").forEach((div: Element) =>
