...
global.select = factory();
      ...
      return function (e) {
        ...
        var m = function () {
          ...
          return a(e, [{
            ...
            key: "_triggerChange",
            value: function value(e) {
              e != null && (0, v.triggerEvent)(this.passedElement, "change", {
                value: e
              });
            }
          }, {
            ...
            value: function value(e) {
              if (e.target === this.input) {
                ...
                v.triggerEvent(this.passedElement, "changeQuery", {
                  value: t
                })
  ...
  var _prepareChoisesConfig = function _prepareChoisesConfig(element) {
    ...
    if (element.hasAttribute(sSearchEmptyAtt)) {
      ...
      obj.noResultsText = vl.i18n.t('select.no_results');
    }

    obj.noChoicesText = vl.i18n.t('select.no_more_options');
        ...
        vl.util.each(this.selectInstances, function (instance) {
          if (instance.element === select) {
            ...
            if (vl.util.exists(closeButton)) {
              ...
              select.hideDropdown(); // Dirty-ish fix, close select that opened because the close button click propagated
            } else {
              instance.removeActiveItems();
            }
          }
