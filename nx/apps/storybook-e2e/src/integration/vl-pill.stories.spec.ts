const pillUrl = 'http://localhost:4600/iframe.html?id=components-vl-pill--default&viewMode=story';
...
describe('story vl-pill', () => {
    ...
    it('should contain a success pill', () => {
        ...
        .shadow()
        .find('.vl-pill')
            .should('have.class', 'vl-pill--success')
    });
    ...
    it('should contain a warning pill', () => {
        ...
        .shadow()
        .find('.vl-pill')
            .should('have.class', 'vl-pill--warning')
    });
    ...
    it('should contain a error pill', () => {
        ...
        .shadow()
        .find('.vl-pill')
            .should('have.class', 'vl-pill--error')
    });
    ...
    it('should contain a disabled pill', () => {
        ...
        .shadow()
        .find('.vl-pill')
            .should('have.class', 'vl-pill--disabled')
    });
