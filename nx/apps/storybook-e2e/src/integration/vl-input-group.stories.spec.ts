describe('story vl-input-group', () => {
    it('should contain an input group', () => {
        cy.visit('http://localhost:4600/iframe.html?args=&id=elements-vl-input-group--default&viewMode=story')
    ...
    it('should contain an input group with a button input addon to the right ', () => {
        cy.visit('http://localhost:4600/iframe.html?args=&id=elements-vl-input-group--with-input-addon-right&viewMode=story')
        cy.getDataCy('input-group')
            .should('have.class', 'vl-input-group')
            .get('input')
            .next('button')
    ...
    it('should contain an input group with a icon button to the left', () => {
        cy.visit('http://localhost:4600/iframe.html?args=&id=elements-vl-input-group--with-button-left&viewMode=story')
        cy.getDataCy('input-group')
            .should('have.class', 'vl-input-group')
            .get('button')
            .next('input')
