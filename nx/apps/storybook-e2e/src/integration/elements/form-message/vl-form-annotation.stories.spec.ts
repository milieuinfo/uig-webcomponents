const formAnnotationDefaultUrl =
    'http://localhost:4600/iframe.html?id=elements-form-message--form-annotation-default&viewMode=story';
const formAnnotationSpanUrl =
    'http://localhost:4600/iframe.html?id=elements-form-message--form-annotation-span&viewMode=story';
