const doormatDefaultUrl = 'http://localhost:4600/iframe.html?id=elements-doormat--doormat-default&viewMode=story';
const doormatWithImageUrl = 'http://localhost:4600/iframe.html?id=elements-doormat--doormat-with-image&viewMode=story';
