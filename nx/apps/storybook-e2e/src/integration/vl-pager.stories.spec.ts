const pagerUrl = 'http://localhost:4600/iframe.html?id=components-vl-pager--default&viewMode=story';
...
describe('story vl-pager', () => {
    it('should be able to go to the next page', () => {
        ...
        cy.getDataCy('pager')
        .shadow()
        .find('#page-back-list-item')
            .should('have.attr', 'hidden')

        // Go to next page
        cy.getDataCy('pager')
        .shadow()
        .find('#page-forward-link')
        .click()
    ...
    it('should contain a centered pager', () => {
        ...
        .shadow()
        .find('.vl-pager')
            .should('have.class', 'vl-pager--align-center')
    });
    ...
    it('should contain a right aligned pager', () => {
        ...
        .shadow()
        .find('.vl-pager')
            .should('have.class', 'vl-pager--align-right')
    });
