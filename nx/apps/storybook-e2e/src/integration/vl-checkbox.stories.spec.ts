const checkboxUrl = 'http://localhost:4600/iframe.html?id=components-vl-checkbox--default&viewMode=story';
const switchUrl = 'http://localhost:4600/iframe.html?id=components-vl-checkbox--switch&viewMode=story';
