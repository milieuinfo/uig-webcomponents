const stepsUrl = 'http://localhost:4600/iframe.html?id=components-vl-steps--default&viewMode=story';
const stepsWithAccordionsUrl = 'http://localhost:4600/iframe.html?id=components-vl-steps--with-accordions&viewMode=story';
const stepsWithTimelineUrl = 'http://localhost:4600/iframe.html?id=components-vl-steps--with-timeline&viewMode=story';
...
describe('story vl-steps', () => {
    it('should contain steps', () => {
        ...
        cy.getDataCy('step-1')
        .shadow()
        .find('span[slot="identifier"]')
            .contains('1')
        cy.getDataCy('step-1')
        .shadow()
        .find('h3.vl-step__title')
        .find('span[slot="title"]')
            .contains('Step 1: action')
        cy.getDataCy('step-1')
        .shadow()
