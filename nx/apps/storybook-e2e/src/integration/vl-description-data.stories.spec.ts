const descriptionDataUrl = 'http://localhost:4600/iframe.html?id=components-vl-description-data--default&viewMode=story';
...
describe('story vl-description-data', () => {
    it('should contain a valid value and label of each description data item', () => {
        ...
        cy.getDataCy('description-data-item-1')
        .shadow()
        ...
        .shadow()
        .find('.vl-description-data__value')
            .contains('Augustus 2018')

        cy.getDataCy('description-data-item-3')
        .shadow()
        .find('.vl-description-data__label')
            .contains('Publicatietype')
