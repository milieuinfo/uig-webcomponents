const toasterUrl = 'http://localhost:4600/iframe.html?id=elements-vl-toaster--default&viewMode=story';
const fadeOutToasterUrl = 'http://localhost:4600/iframe.html?id=elements-vl-toaster--fade-out&viewMode=story';

describe('story vl-toaster', () => {
    it('should contain a toaster in the top left corner of the page', () => {
        cy.visit(`${toasterUrl}`)

        cy.getDataCy('button-top-left')
        .click()
    ...
    it('should contain a toaster in the bottom left corner of the page', () => {
        ...
        cy.getDataCy('button-bottom-left')
        .click()
    ...
    it('should contain a toaster in the bottom right corner of the page', () => {
        ...
        cy.getDataCy('button-bottom-right')
        .click()
