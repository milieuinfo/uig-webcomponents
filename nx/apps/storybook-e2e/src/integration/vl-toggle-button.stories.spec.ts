const toggleButtonUrl = 'http://localhost:4600/iframe.html?id=components-vl-toggle-button--default&viewMode=story';
const toggleButtonWithIconUrl = 'http://localhost:4600/iframe.html?id=components-vl-toggle-button--with-icon&viewMode=story';
...
describe('story vl-toggle-button', () => {
    ...
    it('should contain a disabled toggle button', () => {
        ...
        .find('button.vl-button')
            .should('have.class', 'vl-button--disabled')
    });
