...
const radioButtonGroupUrl = 'http://localhost:4600/iframe.html?id=components-vl-radio-vl-radio-group--default&viewMode=story';
...
describe('story vl-radio', () => {
    ...
    it.skip('should contain a radio button in an error state', () => {
        ...
        .shadow()
        .find('label.vl-radio')
            .should('have.class', 'vl-radio--error')
    });
