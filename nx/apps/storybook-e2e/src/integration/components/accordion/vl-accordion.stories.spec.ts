const accordionUrl = 'http://localhost:4600/iframe.html?id=components-vl-accordion--default&viewMode=story';
const accordionWithTitleSlotUrl = 'http://localhost:4600/iframe.html?id=components-vl-accordion--with-title-slot&viewMode=story';
const dynamicAccordionUrl = 'http://localhost:4600/iframe.html?id=components-vl-accordion--dynamic-toggle&viewMode=story';
...
describe('story vl-accordion', () => {
    ...
    it('should contain content', () => {
        ...
        cy.getDataCy('accordion')
        .find('span')
            .contains('Onderwijs helpt jonge mensen en volwassenen om zichzelf te ontwikkelen en hun weg te vinden in onze samenleving. Het hoger onderwijs speelt daarnaast een belangrijke rol in innovatie dankzij het belang van wetenschappelijk onderzoek.')
    });
