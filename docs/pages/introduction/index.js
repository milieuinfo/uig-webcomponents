      ...
      children: html`<section is="vl-region">
        ...
        children: html`
                <vl-typography>
                  <ul>
                    <li>
                      The <code>infotext</code> component has a console log error when this component is being used more
                      than once on a page. This issue will be resolved in the future.
                    </li>
                  </ul>
                </vl-typography>
              `,
