          ...
          ...config.module.rules,
          {
            ...
            options: {
              multiple: [
                {
                  search: new RegExp(
                    /(?:\/font\/flanders\/italic\/FlandersArtSans)/gm
                  ),
                  replace:
                ...
                {
                  search: new RegExp(
                    /(?:\/font\/flanders\/sans\/FlandersArtSans)/gm
                  ),
                  replace:
                ...
                {
                  search: new RegExp(
                    /(?:\/font\/flanders\/serif\/FlandersArtSerif)/gm
                  ),
                  replace:
                ...
                {
                  search: new RegExp(
                    /(?:\/font\/iconfont\/vlaanderen-icon.woff)/gm
                  ),
                  replace:
