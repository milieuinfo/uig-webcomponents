...
.vl-link--inline .vl-link__icon--after {
  position: relative;
}
.vl-link__icon--light {
  color: #687483;
...
.js-vl-accordion--open .vl-toggle .vl-vi-arrow-right-fat::before, .js-vl-toggle--open .vl-toggle .vl-vi-arrow-right-fat::before, [aria-expanded=true] > .vl-toggle .vl-vi-arrow-right-fat::before,
...
.vl-button--naked:hover, .vl-button--naked:focus, .vl-button--naked:active, .vl-button--naked:visited {
  border: 0;
  color: #333332;
  background-color: transparent;
}
...
.vl-u-mark--info {
  background-color: transparent;
  box-shadow: inset 0 -10px 0 0 rgba(198, 83, 140, 0.4);
}
...
.vl-u-hr {
  border: 0;
  border-bottom: 1px solid #c6538c;
  margin-top: 0;
  margin-bottom: 0;
}
.vl-u-hr--wave {
