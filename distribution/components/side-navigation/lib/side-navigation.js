      ...
      _createClass(Sticky, [{
        ...
        value: function _stickyPosition(force) {
          ...
          if ((this.affixedType !== affixType || force) && affixType) {
            ...
            this.sidebarInner.classList.remove(stiStaticClass, stiViewportTopClass, stiViewportBottomClass, stiViewportUnbottom, stiViewportContainerBottom);
    ...
    var _scrollSpyMobile = function _scrollSpyMobile(elements, wrapper, contentWrapper) {
      ...
      if (vl.util.exists(placeholder)) {
        ...
        if (vl.util.exists(contentWrapper)) {
          ...
          window.addEventListener('scroll', vl.util.debounce(function () {
            if (window.pageYOffset > openButtonOffsetHeight && window.pageYOffset < openButtonOffsetHeight + wrapperHeight - document.documentElement.clientHeight) {
    ...
    var ScrollSpy = /*#__PURE__*/function () {
      ...
      _createClass(ScrollSpy, [{
        ...
        value: function dressAll() {
          ...
          var scrollSpies = document.querySelectorAll("[".concat(ssAtt, "]:not([").concat(ssDressedAtt, "])"));
      ...
      _createClass(SideNavigation, [{
        ...
        value: function dress(sideNav) {
          ...
          if (vl.util.exists(ResizeSensor_min) && vl.util.exists(vl.sticky)) {
            new ResizeSensor_min(sideNav.getRootNode().querySelectorAll("[".concat(snScrollSpyContentAtt, "]")), vl.util.debounce(vl.sticky.handleEvent, 50));
          }
        ...
        value: function dressAll() {
          ...
          var allSideNavigations = document.querySelectorAll("[".concat(snAtt, "]:not([data-").concat(vl.ns, "js-dress=\"false\"])"));
  
          if (!vl.util.exists(allSideNavigations)) {
            allSideNavigations = document.querySelectorAll(".".concat(snClass, ":not([data-").concat(vl.ns, "js-dress=\"false\"])"));
          }
