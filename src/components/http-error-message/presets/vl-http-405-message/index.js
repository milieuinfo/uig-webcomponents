...
export class VlHttp405Message extends LitElement {
  ...
  render() {
    return html`
      ...
      >
        <p slot="text">
          Er ging iets fout. <a href="mailto:help@omgevingvlaanderen.be?subject=HTTP-code 405">Mail de helpdesk</a> en
          vermeld daarbij de URL hierboven en de foutcode 405.
        </p>
        <div slot="actions">
