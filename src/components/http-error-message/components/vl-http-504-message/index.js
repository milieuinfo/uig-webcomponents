...
export class VlHttp504Message extends LitElement {
  static get styles() {
    return [
      css`
        ${unsafeCSS(styles)}
    ...
    return html`
      ...
      >
        <p slot="text">
          ...
          <a href="mailto:help@omgevingvlaanderen.be?subject=HTTP-code 504">mail dan de helpdesk</a> en vermeld daarbij
          de URL hierboven en de foutcode 504.
        </p>
        <div slot="actions">
