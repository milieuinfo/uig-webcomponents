...
import VlTooltipPage from "./tooltip.page";
...
describe("vl-tooltip", async () => {
  ...
  it("als gebruiker kan ik over een knop hoveren om de tooltip bovenaan te zien", async () => {
    ...
    await assertTooltipIsZichtbaarMetText(
      tooltip,
      "This is tooltip on the top"
    );
  ...
  //   const buttonInsideShadowDOM =
  //     await vlTooltipPage.getShadowDOMTooltipButton();
  //   const tooltip = await vlTooltipPage.getTopTooltip();
