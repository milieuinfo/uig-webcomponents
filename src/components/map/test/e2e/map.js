...
import { VlMapBaseLayer } from '../../components/baselayer/test/e2e/baselayer.js';
import { VlMapSearch } from '../../components/search/test/e2e/search.js';
import { VlMapLayers } from '../../components/layer/test/e2e/layers.js';
import { VlMapWfsLayer } from '../../components/layer/vector-layer/wfs-layer/test/e2e/wfs-layer.js';
import { VlMapTiledWmsLayer } from '../../components/layer/wms-layer/tiled-wms-layer/test/e2e/tiled-wms-layer.js';
import { VlMapImageWmsLayer } from '../../components/layer/wms-layer/image-wms-layer/test/e2e/image-wms-layer.js';
import { VlMapWmtsLayer } from '../../components/layer/wmts-layer/test/e2e/wmts-layer.js';
import { VlMapFeaturesLayer } from '../../components/layer/vector-layer/features-layer/test/e2e/features-layer.js';
import { VlMapOverviewMap } from '../../components/overview-map/test/e2e/overview-map.js';
import { VlMapLayerSwitcher } from '../../components/layer-switcher/test/e2e/layer-switcher.js';
import { VlMapSideSheet } from '../../components/side-sheet/test/e2e/side-sheet.js';
...
export class VlMap extends VlElement {
  ...
  /**
   * Move a point based on its coordinate to another place on the map.
   *
   * @param {Number[]} from - coordinate to move from
   * @param {Number[]} to - coordinate to move to
   * @return {Promise<void>}
   */
  ...
  /**
   * Enter the pixels for a coordinate on the map.
   * Relative to the height and width of the same map.
   *
   * @param {Number[]} coordinates - coordinate on the map
