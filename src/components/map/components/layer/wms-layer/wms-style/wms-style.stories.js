...
export const Default = () => {
  const sldString = `<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0.0" xsi:schemaLocation="http://www.opengis.net/sld StyledLayerDescriptor.xsd">
  <NamedLayer>
  ...
  return html`
    <vl-map>
      ...
      >
        <vl-map-wms-style data-vl-sld=${sldString}></vl-map-wms-style>
      </vl-map-tiled-wms-layer>
    </vl-map>
  `;
};
