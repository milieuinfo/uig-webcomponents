...
/**
 * This is a version of the VlMapWithActions that contains some extra functions such as zooming to a certain extent (or bounding box), toggle the layers, and all functionality related to an overview map (ol.control.OverviewMap).
 * The view can be given in the map options object during construction or a default view can be created based on the projection.
 */
