...
describe('split action', () => {
  ...
  it('when activated will add a select and draw action to the map and activate the select interactions', () => {
  ...
  it('when deactivated will deactivate both the select and draw action', () => {
    const splitAction = createSplitAction();
  ...
  it('after selecting will deactivate the select action and activate the draw action', () => {
    const splitAction = createSplitAction();
  ...
  it('will after selecting and drawing the split callback will be executed with the selected feature and the split features', () => {
    const splitAction = createSplitAction();
  ...
  it('after selecting and drawing will deselect the last selected feature, deactivate the map action and activate the select action', (done) => {
    const splitAction = createSplitAction();
