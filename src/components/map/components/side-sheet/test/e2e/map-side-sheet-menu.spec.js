...
import { VlMapSideSheetMenuItemPage } from "../../../side-sheet-menu-item/test/e2e/side-sheet-menu-item.page.js";
...
describe("vl-map-side-sheet-menu-item", async () => {
  ...
  it("als gebruiker zie ik de menu inhoud", async () => {
    ...
    await assert.eventually.equal(
      slotElements[0].getText(),
      "Gelieve een resultaat aan te maken"
    );
  });
});
