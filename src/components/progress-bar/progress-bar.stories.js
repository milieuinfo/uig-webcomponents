  ...
  parameters: {
    docs: {
      description: {
        component: docsIntro({
          root: 'progress-bar',
          intro: 'Use the progress bar component to show the progress for a specific or multi-step process.',
        }),
      },
    },
  },
...
export const Default = ({ numeric, activeStep, steps, focusOnChange, onClickStep }) => {
