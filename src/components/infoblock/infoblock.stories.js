  ...
  parameters: {
    docs: {
      description: {
        component: docsIntro({
          root: 'infoblock',
          intro: 'Gebruik de infoblock om een sectie met een nieuwe content te starten.',
        }),
      },
    },
  },
...
const Template = ({ title, content, type, icon }) =>
  html`<vl-infoblock data-vl-title=${title} data-vl-type=${ifDefined(type)} data-vl-icon=${icon}>
    ${content}
  </vl-infoblock>`;
