...
export default {
  ...
  argTypes: {
    validate: {
      ...
      description:
        "Attribuut wordt gebruikt om aan te geven dat de input velden validatie geactiveerd moet worden.",
      table: {
  ...
  <form is="vl-form" data-vl-validate="">
    <div is="vl-form-group">
      <div is="vl-form-grid" data-vl-is-stacked="">
        ...
        <div is="vl-form-column" data-vl-size="3">
          <label is="vl-form-label" for="phone" data-vl-block=""
            >Telefoon</label
          >
        </div>
        <div is="vl-form-column" data-vl-size="9">
