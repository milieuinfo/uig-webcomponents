...
import VlFormValidationPage from "./form-validation.page";
...
describe("vl-form-validation", async () => {
  ...
  it("als gebruiker zie ik een foutmelding als een uuid niet geldig is", async () => {
    ...
    const invalidUuids = [
      "abc",
      "1c6fa548-5eef-11ez-ae93-0242ac130002",
      "1c6fa548-5eef-11ez-ae93-0242ac130002a",
      "1c6fa5485eef11ezae930242ac130002a",
    ];
    ...
    const validUuids = [
      "1c6fa548-5eef-11ea-ae93-0242ac130002",
      "12345678-ABCD-1234-ef00-0123456789ef",
    ];
  ...
  it("als gebruiker zie ik een foutmelding als het gehele getal niet tussen het ingestelde bereik ligt", async () => {
    ...
    await assert.eventually.equal(
      input.getNumericalGreaterThanOrEqualTo(),
      "2"
    );
    await assert.eventually.equal(
      input.getNumericalLessThanOrEqualTo(),
      "1000"
    );
