(function (global, factory) {
  ...
  !function () {
    ...
    */
    ...
    function j(n) {
      this.H = RegExp(" "), this.C = "", this.m = new e(), this.w = "", this.i = new e(), this.u = new e(), this.l = !0, this.A = this.o = this.F = !1, this.G = $.b(), this.s = 0, this.b = new e(), this.B = !1, this.h = "", this.a = new e(), this.f = [], this.D = n, this.J = this.g = B(this, this.D);
    }
    ...
    function C(n, t) {
      ...
      if (!n.l) {
        if (!n.F) if (P(n)) {
          if (q(n)) return I(n);
        } else if (0 < n.h.length && (e = n.a.toString(), l(n.a), n.a.a(n.h), n.a.a(e), e = n.b.toString(), r = e.lastIndexOf(n.h), l(n.b), n.b.a(e.substring(0, r))), n.h != H(n)) return n.b.a(" "), I(n);
        return n.i.toString();
      }
      ...
      switch (n.u.b.length) {
        ...
        default:
          return n.A ? (q(n) && (n.A = !1), n.b.toString() + n.a.toString()) : 0 < n.f.length ? (e = T(n, t), r = D(n), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? G(n) : n.l ? M(n, e) : n.i.toString())) : V(n);
      }
    }
    ...
    function q(n) {
      ...
      n: {
        if (t = n.a.toString(), 0 != t.length && "0" != t.charAt(0)) for (var i, u = t.length, a = 1; 3 >= a && a <= u; ++a) {
      ...
      return 0 != t && (l(n.a), n.a.a(r.toString()), r = E(t), "001" == r ? n.g = N(n.G, "" + t) : r != n.D && (n.g = B(n, r)), n.b.a("" + t).a(" "), n.h = "", !0);
    }
    ...
    e.prototype.b = "", e.prototype.set = function (n) {
      ...
      if (this.b += String(n), null != t) for (var l = 1; l < arguments.length; l++) {
        this.b += arguments[l];
      }
      return this;
  ...
  var Pattern = /*#__PURE__*/function () {
    ...
    _createClass(Pattern, [{
      ...
      value: function dressAll() {
        ...
        var patternFields = document.querySelectorAll("[".concat(pAttr, "]:not([").concat(pDressedAtt, "]):not([data-").concat(vl.ns, "js-dress=\"false\"])"));
