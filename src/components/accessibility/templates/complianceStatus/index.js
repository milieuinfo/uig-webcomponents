  ...
  const complianceTemplate = () => {
    switch (compliance) {
      ...
      case COMPLIANCE_STATUS.PARTIALLY_COMPLIANT:
        return html`Deze website voldoet gedeeltelijk aan de ${wcagLink()} omdat
        nog niet aan de onderstaande eisen is voldaan.`;
        break;
      case COMPLIANCE_STATUS.NOT_COMPLIANT:
        return html`Deze website voldoet niet aan de ${wcagLink()} omdat nog
        niet aan de onderstaande eisen is voldaan.`;
        break;
      default:
        return null;
        break;
